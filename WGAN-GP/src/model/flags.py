...
def define_flags():
    ...
    # Training parameters
    ###########################
    tf.app.flags.DEFINE_integer('nb_epoch', 100, "Number of epochs")
    tf.app.flags.DEFINE_integer('batch_size', 16, "Number of samples per batch.")
    tf.app.flags.DEFINE_integer('nb_batch_per_epoch', 134, "Number of batches per epoch")
    ...
    tf.app.flags.DEFINE_string('Xwithout', "/home/ubuntu/makeup_removal/gan_makeup_data_96/without", "Path to celebA images")
    tf.app.flags.DEFINE_string('Xwith', "/home/ubuntu/makeup_removal/gan_makeup_data_96/with", "Path to celebA images")
    ...
    tf.app.flags.DEFINE_integer('img_size', 96, "Image size")
